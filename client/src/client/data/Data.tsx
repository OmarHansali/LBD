...
const socialMediaData = [
  {
    title: 'YouTube',
    platform: "S'abonner à la chaîne",
    description: 'Abonnez-vous à notre chaîne YouTube pour des contenus exclusifs et des mises à jour régulières. Ne manquez aucune de nos vidéos captivantes !',
  },
  {
    title: 'Facebook',
    platform: 'Aimer la page',
    description: 'Aimez notre page Facebook pour rester connecté avec notre communauté et recevoir les dernières nouvelles.',
  },
  {
    title: 'Instagram',
    platform: 'Suivre le compte',
    description: 'Suivez notre compte Instagram pour des moments en coulisse et des publications pleines de créativité !',
  },
  {
    title: 'Twitter',
    platform: 'Suivre le compte',
    description: 'Suivez notre compte Twitter pour les dernières actualités et participez à notre communauté active !',
  },
];
