        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 col-10 col-xxs-12">
              <h1 className="tl-14-banner-title">
                Enhancing Learning with Language Models.
              </h1>
              <p className="tl-14-banner-descr">
              ...
              <form action="#" className="tl-14-banner-search-form">
                <input
                  type="search"
                  name="Search"
                  className="tl-14-banner-search-field"
                  id="tl-14-banner-search-field"
                  placeholder="Search your course"
                />
                <button
                  type="submit"
                  className="tl-def-btn tl-14-def-btn tl-14-banner-search-btn"
                >
                  Find course
                </button>
              </form>
