  ...
  return (
    <section className="tl-12-courses tl-11-section-spacing">
      <div className="container">
        ...
        <Swiper
          className="tl-12-courses-slider"
          id="tl-12-courses-slider"
          slidesPerView={3}
          spaceBetween={20}
          loop={true}
          navigation={{
                ...
                <div className="tl-12-course-txt">
                  ...
                  <div className="tl-12-course-stats">
                    <div className="tl-12-course-stat">
                      <span className="tl-12-course-stat-icon">
                        <i className="fa-regular fa-book-blank"></i>
                      </span>
                      <span className="tl-12-course-stat-txt">
                  ...
                  <h4 className="tl-12-course-title">
                    <Link to={`/course/${item.slug}`}>{item.title}</Link>
                  </h4>
                  <p className="tl-12-course-descr">{item.desc}</p>
                  <Link
                    to={`/course/${item.slug}`}
                    className="tl-12-course-btn"
                  >
                    {" "}
                    View Course <i className="fa-regular fa-arrow-right"></i>
                  </Link>
                </div>
              </div>
            </SwiperSlide>
