      ...
      <div className="container">
        <div className="tl-13-section-heading">
          <h2 className="tl-13-section-title">
            Explore Popular <span className="last-word">Courses</span>
          </h2>
          <div className="tl-13-courses-slider-nav">
            <button
              type="button"
              role="presentation"
              className="tl-13-courses-prev"
            >
            ...
            <SwiperSlide className="tl-9-class tl-13-course" key={item.id}>
              ...
              <div className="tl-13-course-actions">
                <Link to={`/course/${item.slug}`} className="tl-9-program-btn">
                  Teaching Online <i className="fa-regular fa-arrow-right"></i>
                </Link>
