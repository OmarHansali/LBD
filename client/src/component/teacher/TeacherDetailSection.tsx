      ...
      <div className="container">
        <div className="tl-staff-profile-top">
          ...
          <div className="tl-staff-profile-txt">
            ...
            <p className="tl-staff-profile-bio">
              an inspiring educator, has dedicated his life to nurturing young
              minds. With a degree in English Education from Riverside
              University, he embarked on his journey at Oakridge High School.
              Through innovative teaching, she cultivated an inclusive classroom
              where every student's voice was valued. Sarah's impact stretched
              beyond the classroom, leading workshops and embracing technology
              to enhance learning. his legacy is woven through the success
              stories of students who continue to be inspired by his passion for
              education.
            </p>
          </div>
        ...
        <div className="tl-staff-profile-courses">
          <h3 className="tl-staff-profile-courses-title">
