    ...
    <section className="tl-10-blog p-120">
      <div className="container">
        <div className="tl-10-blog-heading d-flex align-items-center justify-content-between">
          <h2 className="tl-section-title tl-10-section-title">
            Our News & <span className="last-word">Blogs</span>.
          </h2>
          <a href="#" className="tl-def-btn">
            Latest News <i className="fa-regular fa-arrow-right"></i>
          </a>
        </div>
            ...
            <div className="col-lg-4 col-md-6 col-sm-10" key={item.id}>
              <div className="tl-single-blog tl-10-single-blog">
                ...
                <div className="tl-10-single-blog-txt">
                  <span className="tl-single-blog-date tl-10-single-blog-date">
                    {item.date}
                  </span>
                  <h4 className="tl-single-blog-title tl-10-single-blog-title">
                    <Link to={`/blog/${item.slug}`}>{item.title}</Link>
                  </h4>
                  <p className="tl-single-blog-descr tl-10-single-blog-descr">
                    {item.desc.slice(0, 80)}...
                  </p>
                  <Link
                    className="tl-single-blog-btn tl-10-single-blog-btn"
                    to={`/blog/${item.slug}`}
                  >
