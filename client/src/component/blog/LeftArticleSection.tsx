    ...
    <div className="tl-11-pop-articles-left-col">
      <div className="tl-11-section-heading">
        ...
        <div className="tl-11-pop-articles-filtering-btns">
          ...
          <button
            onClick={() => handleFilterChange("Revolution")}
            className={selectedCategory === "Revolution" ? "active " : ""}
          >
            Revolution
          </button>
          <button
            onClick={() => handleFilterChange("Learning")}
            className={selectedCategory === "Learning" ? "active " : ""}
          >
            Learning
          </button>
          <button
            onClick={() => handleFilterChange("Notebook")}
            className={selectedCategory === "Notebook" ? "active " : ""}
          >
            Notebook
          </button>
        </div>
      ...
      <div className="tl-11-pop-articles-col">
        {blogList.slice(33, 37).map(
          (item, index) =>
            (selectedCategory === "all" ||
              item.category === selectedCategory) && (
              <div
                className={`tl-11-pop-article mix ${item.category}`}
                key={index}
              >
                ...
                <div className="tl-11-pop-article-txt">
                  <div className="tl-11-pop-article-infos">
                    <Link to="/blog">
                      <span className="tl-11-pop-article-category">
                        {item.category}
                      </span>
                    </Link>
